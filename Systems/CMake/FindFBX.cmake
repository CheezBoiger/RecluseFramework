...
ELSEIF(CMAKE_CL_64)
	SET(FBX_LIBEXT x64)
    SET(FBX_LIBDIR ${FBX_LIBDIR}/${FBX_LIBEXT})
...
FIND_LIBRARY( FBX_LIBRARY ${FBX_LIBNAME}
    PATHS ${FBX_SEARCH_PATHS}
    PATH_SUFFIXES "lib/${FBX_LIBDIR}/release" "lib/${FBX_LIBDIR}" "lib/${FBX_LIBEXT}/release")
...
FIND_LIBRARY( FBX_LIBRARY_DEBUG ${FBX_LIBNAME}
    PATHS ${FBX_SEARCH_PATHS}
    PATH_SUFFIXES "lib/${FBX_LIBDIR}/debug" "lib/${FBX_LIBEXT}/debug")
FIND_LIBRARY( FBX_LIBRARY_DEBUG ${FBX_LIBNAME_DEBUG}
    PATHS ${FBX_SEARCH_PATHS}
    PATH_SUFFIXES "lib/${FBX_LIBDIR}" "lib/${FBX_LIBEXT}")
